		...
		<section className={styles.section}>
			...
			>
				<div className={styles.sectionHeader}>
					...
					<h2 className={styles.sectionTitle}>Comprehensive Facility Services</h2>
					<p className={styles.sectionDesc}>
						From personnel outsourcing to specialized cleaning and pest control, we deliver excellence
						across all facility service needs.
					</p>
				</div>
			</motion.div>
							...
							>
								...
								>
									{service.features.map((feature) => (
										...
										>
											<CheckCircleIcon style={{ fontSize: 18, color: service.color, flexShrink: 0 }} />
											<span>{feature}</span>
										</motion.li>
									))}
								</motion.ul>
